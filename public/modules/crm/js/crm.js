...
*/
	...
	function updateLeadLifeStageForKanban(data, el) {
		$.ajax({
	        method: 'GET',
	        dataType: 'json',
	        url: '/contact-leads/' + data.lead_id + '/post-life-stage',
	        data:data,
	        success: function(result){
	            if (result.success) {
 ...
 */
	...
	$(document).on('click', '.btn-create-campaign', function() {
		var url = $(this).data('href');
	    $.ajax({
	        method: 'GET',
	        url: url,
	        dataType: 'html',
	        success: function(result) {
	            $('.campaign_modal').html(result).modal('show');
	        }
	    });
	});
	...
	$('.campaign_modal').on('shown.bs.modal', function (e) {
	...
	$(document).on('submit', 'form#campaign_form', function(e){
	    e.preventDefault();
	    var url = $('form#campaign_form').attr('action');
	    var method = $('form#campaign_form').attr('method');
	    var data = $('form#campaign_form').serialize();
