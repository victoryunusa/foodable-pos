    ...
    */
    ...
    public function create()
    {
        ...
        return view('expense.create')
            ->with(compact('expense_categories', 'business_locations', 'users', 'taxes', 'payment_line', 'payment_types', 'accounts', 'bl_attributes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $transaction_data['recur_interval'] = $request->has('is_recurring') && !empty($request->input('recur_interval')) ? $request->input('recur_interval') : 1;
            $transaction_data['recur_interval_type'] = $request->has('is_recurring') && !empty($request->input('recur_interval_type')) ? $request->input('recur_interval_type') : null;
            $transaction_data['recur_repetitions'] = $request->has('is_recurring') && !empty($request->input('recur_repetitions')) ? $request->input('recur_repetitions') : null;
            $transaction_data['subscription_repeat_on'] = $request->input('recur_interval_type') == 'months' && !empty($request->input('subscription_repeat_on')) ? $request->input('subscription_repeat_on') : null;
