...
class ContactController extends Controller
{
    ...
    private function indexCustomer()
    {
        ...
        $query = Contact::leftjoin('transactions AS t', 'contacts.id', '=', 't.contact_id')
                    ...
                    ->where('contacts.business_id', $business_id)
                    ->onlyCustomers()
                    ->select(['contacts.contact_id', 'contacts.name', 'contacts.created_at', 'total_rp', 'cg.name as customer_group', 'city', 'state', 'country', 'address_line_1', 'address_line_2', 'mobile', 'contacts.id', 'is_default',
